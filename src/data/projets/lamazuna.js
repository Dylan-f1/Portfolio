export const lamazuna = {
  ...
  conclusionOrale: "Lamazuna est le storefront e-commerce d'une marque de cosmétiques solides zéro déchet, entièrement reconstruit en Next.js App Router avec TypeScript strict et Saleor comme backend e-commerce headless via GraphQL. Le site propose un compte client complet, un panier et un checkout fonctionnels, ainsi qu'un store locator interactif basé sur Mapbox GL JS. Il affiche un score Lighthouse supérieur à 90 en performance, SEO et accessibilité, avec zéro erreur de compilation TypeScript sur l'ensemble du projet.",
