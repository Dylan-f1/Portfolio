  ...
  const projetsEntreprise = [
    {
      id: 1,
      title: "ZAO - Makeup",
      description: "Plateforme e-commerce complète avec système de paiement intégré (PayPal, Stripe, Monetico) et gestion de checkout optimisée, Refonte du Checkout",
      image: "/LOGO-ZAO_VF.png",
      link: "https://shop.zaomakeup.com/fr/#utm_source=zaovitrine&utm_medium=referral&utm_campaign=boutonboutique",
    },
    {
      id: 2,
      title: "Lamazuna E-Shop",
      description: "Refonte total du Site de Lamazuna",
      image: "/LMA.jpg",
      link: "",
    }
